...
export const metadata: Metadata = {
  title: "AI 英语口语陪练 | AI English Coach",
  description:
    "智能英语口语练习工具，支持多种真实场景对话训练、实时发音评测、语法纠错与课后学习总结。",
  keywords: [
    "AI",
    "英语口语",
    "口语练习",
    ...
    <html lang="zh-CN">
      <body>
        ...
        <nav className="nav">
          <div className="nav-inner container">
            ...
            <div className="nav-links hide-mobile">
              ...
              <a
                href="https://github.com/Qcxiaoyuksp/ai-english-coach"
                className="nav-link"
                target="_blank"
        ...
        <nav className="mobile-nav hide-desktop">
          ...
          <Link href="/history" className="mobile-nav-item">
